...
export default function MusicPlayerButton() {
  ...
  return (
    <>
      <button
        className="fixed bottom-5 right-5 w-16 h-16 rounded-full bg-brand-green text-dark-card border-2 border-brand-green text-3xl shadow-lg z-[999] flex items-center justify-center transition-all duration-300 cursor-pointer hover:bg-brand-accent hover:border-brand-accent hover:scale-110 hover:shadow-xl active:scale-95"

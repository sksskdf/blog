...
export default function HomeClient({ initialPosts, initialSettings }: HomeClientProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="border-t border-dark-border divide-y divide-dark-border pb-28 md:pb-24"
